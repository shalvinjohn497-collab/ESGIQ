...
export const UPLOAD_CATEGORIES = [
    ...
    { id: 'refrigerants', label: 'Refrigerants', icon: <Wind size={22} color={C.violet} />, iconComponent: Wind, months: 8, total: 12, c: C.violet, desc: 'Upload AC/refrigerant data' },
    { id: 'transport', label: 'Transport', icon: <Truck size={22} color={C.rose} />, iconComponent: Truck, months: 6, total: 12, c: C.rose, desc: 'Upload transport data' },
    { id: 'governance', label: 'Governance', icon: <Shield size={22} color={C.green} />, iconComponent: Shield, months: null, total: null, pct: 85, c: C.green, desc: 'Upload policies & docs' },
];
